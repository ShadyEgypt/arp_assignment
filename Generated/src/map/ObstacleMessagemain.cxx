        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<ObstacleMessageApplication> app;
    ...
    else
    {
        try
        {
            app = ObstacleMessageApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&ObstacleMessageApplication::run, app);
