...
/*!
 * @file TargetMessageTypeObjectSupport.cxx
 * Source file containing the implementation to register the TypeObject representation of the described types in the IDL file
 *
 * This file was generated by the tool fastddsgen.
 */

#include "TargetMessageTypeObjectSupport.hpp"
...
void register_TargetMessage_type_identifier(
        TypeIdentifierPair& type_ids_TargetMessage)
{

    ReturnCode_t return_code_TargetMessage {eprosima::fastdds::dds::RETCODE_OK};
    return_code_TargetMessage =
        eprosima::fastdds::dds::DomainParticipantFactory::get_instance()->type_object_registry().get_type_identifiers(
        "TargetMessage", type_ids_TargetMessage);
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_TargetMessage)
    {
        StructTypeFlag struct_flags_TargetMessage = TypeObjectUtils::build_struct_type_flag(eprosima::fastdds::dds::xtypes::ExtensibilityKind::APPENDABLE,
                false, false);
        QualifiedTypeName type_name_TargetMessage = "TargetMessage";
        eprosima::fastcdr::optional<AppliedBuiltinTypeAnnotations> type_ann_builtin_TargetMessage;
        eprosima::fastcdr::optional<AppliedAnnotationSeq> ann_custom_TargetMessage;
        CompleteTypeDetail detail_TargetMessage = TypeObjectUtils::build_complete_type_detail(type_ann_builtin_TargetMessage, ann_custom_TargetMessage, type_name_TargetMessage.to_string());
        CompleteStructHeader header_TargetMessage;
        header_TargetMessage = TypeObjectUtils::build_complete_struct_header(TypeIdentifier(), detail_TargetMessage);
        CompleteStructMemberSeq member_seq_TargetMessage;
        {
            ...
            ann_custom_TargetMessage.reset();
            CompleteMemberDetail detail_id = TypeObjectUtils::build_complete_member_detail(name_id, member_ann_builtin_id, ann_custom_TargetMessage);
            CompleteStructMember member_id = TypeObjectUtils::build_complete_struct_member(common_id, detail_id);
            TypeObjectUtils::add_complete_struct_member(member_seq_TargetMessage, member_id);
        }
        {
            ...
            ann_custom_TargetMessage.reset();
            CompleteMemberDetail detail_x = TypeObjectUtils::build_complete_member_detail(name_x, member_ann_builtin_x, ann_custom_TargetMessage);
            CompleteStructMember member_x = TypeObjectUtils::build_complete_struct_member(common_x, detail_x);
            TypeObjectUtils::add_complete_struct_member(member_seq_TargetMessage, member_x);
        }
        {
            ...
            ann_custom_TargetMessage.reset();
            CompleteMemberDetail detail_y = TypeObjectUtils::build_complete_member_detail(name_y, member_ann_builtin_y, ann_custom_TargetMessage);
            CompleteStructMember member_y = TypeObjectUtils::build_complete_struct_member(common_y, detail_y);
            TypeObjectUtils::add_complete_struct_member(member_seq_TargetMessage, member_y);
        }
        CompleteStructType struct_type_TargetMessage = TypeObjectUtils::build_complete_struct_type(struct_flags_TargetMessage, header_TargetMessage, member_seq_TargetMessage);
        if (eprosima::fastdds::dds::RETCODE_BAD_PARAMETER ==
                TypeObjectUtils::build_and_register_struct_type_object(struct_type_TargetMessage, type_name_TargetMessage.to_string(), type_ids_TargetMessage))
        {
            EPROSIMA_LOG_ERROR(XTYPES_TYPE_REPRESENTATION,
                    "TargetMessage already registered in TypeObjectRegistry for a different type.");
        }
    }
}
