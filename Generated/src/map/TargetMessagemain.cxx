        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<TargetMessageApplication> app;
    ...
    else
    {
        try
        {
            app = TargetMessageApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&TargetMessageApplication::run, app);
