...
- **Obstacles Generator**: generates obstacles' points.
- **Obstacles Publisher**: Publishes the generated obstacles' points to the other machine.
- **Targets Subscriber**: Subscribes to a topic to get the generated targets' points from the other machine.
